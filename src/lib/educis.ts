...
export const GRADES = [
  { id: 'elementary', label: 'Elementary', ages: 'Ages 6–10', desc: 'Simple stories, big ideas' },
  { id: 'middle', label: 'Middle School', ages: 'Ages 11–14', desc: 'Concepts meet real life' },
  { id: 'high', label: 'High School', ages: 'Ages 15–17', desc: 'Advanced, career-ready depth' },
];
...
export const COUNTRIES = [
  ...
  { code: 'PY', name: 'Paraguay', flag: '🇵🇾', region: 'Latin America' },
...
export const SUBJECTS = [
  { name: 'Mathematics', icon: 'calculator', color: '#00d4ff' },
  { name: 'Chemistry', icon: 'flask-conical', color: '#8b5cf6' },
  { name: 'Biology', icon: 'leaf', color: '#00ff88' },
  { name: 'Physics', icon: 'zap', color: '#fbbf24' },
  { name: 'History', icon: 'scroll', color: '#d4a843' },
  { name: 'Geography', icon: 'globe', color: '#22d3ee' },
  { name: 'Economics', icon: 'trending-up', color: '#f97316' },
  { name: 'Ethics', icon: 'scale', color: '#e879f9' },
  { name: 'Environmental Science', icon: 'tree', color: '#86efac' },
  { name: 'Social Studies', icon: 'users', color: '#fb923c' },
  { name: 'Media Literacy', icon: 'monitor', color: '#a78bfa' },
  { name: 'Cultural Studies', icon: 'heart', color: '#f43f5e' },
];

export function subjectColor(name: string): string {
  return SUBJECTS.find(s => s.name === name)?.color ?? '#8b5cf6';
}
